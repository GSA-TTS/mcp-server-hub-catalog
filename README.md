...
| **NEPA CFR** | Resolve, browse, and diff Code of Federal Regulations text and trace the Federal Register rulemaking behind it | [eCFR](https://www.ecfr.gov/developers/documentation/api/v1) & [Federal Register](https://www.federalregister.gov/developers/documentation/api/v1) APIs | [`cfr.yaml`](cfr.yaml) | [docs](docs/servers/cfr.md) |
| **NEPA Census** | Establish socioeconomic baseline conditions for NEPA analysis from U.S. Census Bureau ACS data by region of interest (per-user API key) | [Census ACS 5-Year Estimates](https://www.census.gov/programs-surveys/acs) | [`census.yaml`](census.yaml) | [docs](docs/servers/census.md) |
